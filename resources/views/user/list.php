...
<!-- 				  <th>Dirty</th> -->
			...
			<?php foreach( $list as $userl ) : ?>
				...
				<?php if($userl['username'] == $user['username']) { continue; } ?>
				
				<tr>
				  <td><?php echo $userl['username']; ?></td>
				  <td><?php echo $userl['firstname']; ?></td>
				  <td><?php echo $userl['lastname']; ?></td>
				  <td class="text-center"><?php echo ($userl['admin'] == 1) ? '<span class="badge badge-pill badge-success">Yes</span>' : '<span class="badge badge-pill badge-light">No</span>'; ?></td>
				  <td><?php echo (!$userl['lastlogin']) ? '' : date('Y-m-d H:i', strtotime($userl['lastlogin'])); ?></td>
